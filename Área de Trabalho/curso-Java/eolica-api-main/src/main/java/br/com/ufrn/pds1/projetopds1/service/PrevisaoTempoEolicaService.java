...
//************************************************************************************************************************************************************************
		...
		public PrevisaoTempoModel instanciarPrevisaoDoTempo(double latitude, double longitude, Map<String, Object> dailyPrevisao) {
			...
			armazemDadosPrevisao.setFator1((List<Double>) dailyPrevisao.get("temperature_2m_max"));
			armazemDadosPrevisao.setFator2((List<Double>) dailyPrevisao.get("temperature_2m_min"));
			armazemDadosPrevisao.setFator4((List<Double>) dailyPrevisao.get("windspeed_10m_max"));
...
//************************************************************************************************************************************************************************
	...
	//***************************************************************************************************************************
		...
		public PrevisaoTempoModel armazenarDadosPrevisao(double latitude, double longitude) {
			...
			armazemDadosPrevisao.setPrevisaoFator1(resultado.get("vento"));
			armazemDadosPrevisao.setFatorMaxPrevisao(resultado.get("temperaturaMaior"));
			armazemDadosPrevisao.setFatorMinPrevisao(resultado.get("temperaturaMenor"));
			armazemDadosPrevisao.setPrevisaoFator2(resultado.get("mediasTemperatura"));
	...
	//******************************************Previsão do tempo***************************************************************
		...
		public List<Alertas> verificarAlertas(PrevisaoTempoModel infoPrev) {
			...
			List<Double> tempMaxPrevisao = infoPrev.getFatorMaxPrevisao();
			List<Double> tempMinPrevisao = infoPrev.getFatorMinPrevisao();
			List<Double> ventos = infoPrev.getPrevisaoFator1();
