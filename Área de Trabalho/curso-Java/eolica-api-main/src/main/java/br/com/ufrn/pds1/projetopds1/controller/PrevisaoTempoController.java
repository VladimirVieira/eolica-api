...
import br.com.ufrn.pds1.projetopds1.service.PrevisaoTempoAgriculturaService;
import br.com.ufrn.pds1.projetopds1.service.PrevisaoTempoClimaUrbanoService;
import br.com.ufrn.pds1.projetopds1.service.PrevisaoTempoEolicaService;
...
public class PrevisaoTempoController {
	...
	private PrevisaoTempoEolicaService previsao;
	//private PrevisaoTempoClimaUrbanoService previsao;
	//private PrevisaoTempoAgriculturaService previsao;
    ...
    public String armazenarPrevisao(@RequestParam double lat, @RequestParam double lon, Model prevmodel) {
		PrevisaoTempoModel prevtempo = previsao.armazenarDadosPrevisao(lat, lon);
    ...
    public String alertas(@RequestParam double lat, @RequestParam double lon, Model alertmodel) {
        PrevisaoTempoModel alertPrevisao = previsao.armazenarDadosPrevisao(lat, lon);
