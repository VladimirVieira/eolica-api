...
//****************************************************************************************************************************************************************
		...
		public DadosDiarioHistoricoModel instanciarDadosDiario(Double latitude, Double longitude,Map<String, Object> daily) {
			...
			armazemDados.setFator1((List<Double>) daily.get("temperature_2m_max"));
			armazemDados.setFator2((List<Double>) daily.get("temperature_2m_min"));
			armazemDados.setFator3((List<Double>) daily.get("windspeed_10m_max"));
...
//****************************************************************************************************************************************************************
		//Calcular Média Temperatura
			@Override
			public List<Double> calcularFatorClimatico1(List<Double> tempMaior, List<Double> tempMenor){
...
//**************************************************************************************************************************************************************
		//Calcular velocidade média do Vento por trimestres
			@Override
			public DadosDiarioHistoricoModel calcularFatorClimatico2(List<String> datasAno, List<Double> ventos, DadosDiarioHistoricoModel armazemDados){
...
//**********************************************************************************************************************************************************
			...
			public DadosDiarioHistoricoModel armazenarDados(double latitude, double longitude) {						
					...
					List<Double> mediasPorDia = calcularFatorClimatico1(tempMaior, tempMenor);
								
					return calcularFatorClimatico2( datasAno, ventos, armazemDados);
