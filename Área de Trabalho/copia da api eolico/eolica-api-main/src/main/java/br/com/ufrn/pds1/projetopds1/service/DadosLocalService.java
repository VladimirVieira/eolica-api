...
public class DadosLocalService {
	...
	//**********************************************************************************************************************
		...
		public String construirUrl(String latitude, String longitude, String data) {
			...
			//aqui muda, para obter para agricultura dados de estresse, no caso precipitação e radiação
			//aqui para eólica é temperatura e vento
			//aqui para clima urbano é sensação térmica e chuva
		}
